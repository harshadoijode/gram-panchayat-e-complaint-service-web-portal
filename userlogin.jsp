...
rst=stmt.executeQuery("select * from userreg where email='"+un+"' and password='"+pw+"'");
if(rst.next()){
session.setAttribute("user",un);
session.setAttribute("username",rst.getString(1));
session.setAttribute("phone",rst.getString(2));
session.setAttribute("phone",rst.getString(3));

response.sendRedirect("appointment.jsp");
%>
<script>
							alert("login successssssss...!");
							window.open("usermenu.html","_self");
							</script>
...
<div class='head'>
  <h1 class='company'>USERS LOGIN PAGE</h1>
</div>
  ...
  <div class='form'>
    ...
    <form align="center">
      ...
      <p align="left">              <span class="style1"><a href="fergotuser.jsp" class='forgot'> Forgot password</a></span></p>
      <p class="style2"> <a href="newuserreg.jsp" class="text style2"><strong>New Users</strong></a>          </p>

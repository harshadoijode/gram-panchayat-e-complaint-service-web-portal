...
<p align="center"><br />
  <br />
  <span class="style11">New Panchayat Office Registration Form</span>  </p>
...
try{
int x=stmt.executeUpdate("insert into panchayatreg  value('"+request.getParameter("s1")+"','"+request.getParameter("s2")+"','"+request.getParameter("s3")+"','"+request.getParameter("s4")+"')");
if(x!=0){
out.print("panchayat Registered successfully");
}
}catch(Exception e){
out.print(e);
}
